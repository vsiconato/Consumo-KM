...
class HistoryPopup(ModalView):
    def __init__(self, records, **kwargs):
        ...
        self.background_color = (1, 1, 1, 1)  # Fundo branco sólido
        ...
        # Layout da grade para exibir os títulos e registros
        ...
        # Adicionando a grade ao layout principal
